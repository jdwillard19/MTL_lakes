...
for lakename in lakes:
    ...
    save_path = "../../../models/single_lake_models/"+lakename+"/pretrain_experiment_normAll_pball"
    ...
    pretrain_path = "../../../models/single_lake_models/"+lakename+"/pretrain_experiment_normAll_pball"
    save_path = "../../../models/single_lake_models/"+lakename+"/PGRNN_basic_normAll_pball"
