...
ids = pd.read_csv("../../metadata/sites_moreThan10ProfilesWithGLM_Mar2020Update.csv")
...
for nid in ids: #for each new additional lake
    ...
    if not os.path.exists(meteo_path):
        ...
        #load nml file
        nml_data = []
        with open('../../data/raw/sb_pgdl_data_release/cfg/nhdhr_'+nid+'.nml', 'r') as file:
    ...
    #obs
    obs_path = "../../../data/raw/sb_pgdl_data_release/obs/nhd_"+nid+"_obs.feather"
